...
urlpatterns = [
    ...
    url(r'^team/$', InvestMentView.as_view(), name="investment"),
    url(r'^en/team/$', EnInvestMentView.as_view(), name="en_investment"),
    url(r'^portfolio/$', InvestProjectView.as_view(), name="investproject"),
    url(r'^en/portfolio/$', EnInvestProjectView.as_view(), name="en_investproject"),
